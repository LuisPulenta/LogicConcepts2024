...
Console.WriteLine("*** EMPRESA DE TRANSPORTE ***");
Console.WriteLine("-----------------------------");
...
do
{
    ...
    while (!routeOptions.Any(x => x.Equals(route)));
...
decimal GetIncomePassangers(string? route, int passangers, int trips)
{
    ...
    switch (route)
    {
        case "1":
            ...
            return value * 1.07m + 50 * (passangers - 200);
        case "2":
            value = 600000m * trips;
            if (passangers <= 50) return value;
            ...
            return value * 1.09m + 60 * (passangers - 200);
        case "3":
            value = 800000m * trips;
            if (passangers <= 50) return value;
            ...
            return value * 1.15m + 100 * (passangers - 200);
        default:
            ...
            return value * 1.17m + 150 * (passangers - 200);
    }
}
...
decimal GetIncomePackages(string? route, int packages10, int packages10_20, int packages20)
{
    ...
    switch (route)
    {
        ...
        case "2":
            ...
            var pacckagesGreather10 = packages10_20 + packages20;
            if (pacckagesGreather10 <= 50) value += pacckagesGreather10 * 120;
            else if (pacckagesGreather10 <= 100) value += pacckagesGreather10 * 140;
            else if (pacckagesGreather10 <= 130) value += pacckagesGreather10 * 160;
            else value += pacckagesGreather10 * 180;
